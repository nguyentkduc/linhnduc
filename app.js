...
togglePlayer.addEventListener("click", function() {
    ...
    if(isHidden){
        ...
        togglePlayer.innerHTML = '<img class="w-[98%]" src="icon/close.svg">';
        trackInfo.style.transitionDelay = "0.4s";
        trackNav.style.transitionDelay = "0.4s";
    } else {
        musicPlayer.classList.add("hide");
        togglePlayer.innerHTML = '<img class="w-full" src="icon/plus.svg">';
...
let trackList = [
    ...
    },
    {
        ...
        path: "music/music_day and night.mp3",
    },
    {
...
function playTrack(){
    currentTrack.play();
    isPlaying = true;
    playPauseBtn.innerHTML = '<img class="w-8" src="icon/pause.svg">';
...
function pauseTrack(){
    currentTrack.pause();
    isPlaying = false;
    playPauseBtn.innerHTML = '<img class="w-8" src="icon/play.svg">';
